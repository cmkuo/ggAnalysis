...
class ggNtuplizer : public edm::EDAnalyzer {
 ...
 private:
  ...
  vector<float>  eleSigmaIEtaIEta2012_;
  ...
  vector<float>  phoSigmaIEtaIEta2012_;
  vector<float>  phoSigmaIEtaIPhi2012_;
  vector<float>  phoSigmaIPhiIPhi2012_;
  vector<float>  phoE1x32012_;
  vector<float>  phoE2x22012_;
  vector<float>  phoE2x5Max2012_;
  vector<float>  phoE5x52012_;
