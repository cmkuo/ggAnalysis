...
void TrainElectronMVA_NonTrig_BDTG_V0() {
  ...
  TFile* inputSignalAll = TFile::Open("./newtmva_Em_27Mar_MC.Real.All.root");   
  TFile* inputBkgTraining = TFile::Open("./newtmva_Em_27Mar_W1J.Fakes.All.root");
  TFile* inputBkgTesting = TFile::Open("./newtmva_Em_27Mar_Z1J.Fakes.All.root");
  ...
  factory->PrepareTrainingAndTestTree("pt > 5 && abs(dz) < 0.1",
                                      "pt > 5 && pt < 35 && abs(dz) < 0.1",
  ...
  TMVA::MethodBase* bdtCat_BDTG_NonTrigV0 = factory->BookMethod( TMVA::Types::kCategory, "BDTCat_BDTG_NonTrigV0","" );
  TMVA::MethodCategory* category_BDTG_NonTrigV0 = dynamic_cast<TMVA::MethodCategory*>(bdtCat_BDTG_NonTrigV0);
  category_BDTG_NonTrigV0->AddMethod("pt < 10 && abs(eta) <= 0.8",
				     "fbrem:deta:dphi:see:spp:e1x5e5x5:R9:etawidth:phiwidth:detacalo:HoE:EoP:eleEoPout:IoEmIoP:gsfchi2:kfchi2:kfhits:",
				     TMVA::Types::kBDT, 
				     "Category_BDTG_NonTrigV0_1",
  ...
  category_BDTG_NonTrigV0->AddMethod("pt < 10 && abs(eta) > 0.8 && abs(eta)<=1.485",
				     "fbrem:deta:dphi:see:spp:e1x5e5x5:R9:etawidth:phiwidth:detacalo:HoE:EoP:eleEoPout:IoEmIoP:gsfchi2:kfchi2:kfhits:",
				     TMVA::Types::kBDT, 
				     "Category_BDTG_NonTrigV0_2",
				     "!H:!V:NTrees=2000:BoostType=Grad:Shrinkage=0.10:!UseBaggedGrad:nCuts=2000:nEventsMin=100:NNodesMax=5:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=6" );
  
  
  
  category_BDTG_NonTrigV0->AddMethod("pt < 10 && abs(eta)> 1.485",
				     "fbrem:deta:dphi:see:spp:e1x5e5x5:R9:etawidth:phiwidth:detacalo:HoE:EoP:eleEoPout:IoEmIoP:gsfchi2:kfchi2:kfhits:PreShowerOverRaw:",
				     TMVA::Types::kBDT, 
				     "Category_BDTG_NonTrigV0_3",
				     "!H:!V:NTrees=2000:BoostType=Grad:Shrinkage=0.10:!UseBaggedGrad:nCuts=2000:nEventsMin=100:NNodesMax=5:UseNvars=4:PruneStrength=5:PruneMethod=CostComplexity:MaxDepth=6" );
